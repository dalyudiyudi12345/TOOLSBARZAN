...
🇧 🇦 🇷 🇿 🇦 🇳     
            TOOLS BARZAN 
WA OWNER:6289652413966 
TELE:t.me/barzankedip2 
GUNAKAN LAH TOOLS INI SEBAIK MUNGKIN JANGAN DI SALAH GUNAKAN 
TOOLS BY BARZAN🥵🥶
========================================================================`)}
// [========================================] //
...
async function bootup() {
  try {
    ...
    permen.question('[\x1b[1m\x1b[31mBARZANSecurity\x1b[0m]: \n', async (skibidi) => {
      if (skibidi === password.trim()) {
        ...
        await sleep(700)
        console.clear()
        console.log(`Welcome To BARZAN Tools ${version}`)
        await sleep(1000)
		    await banner()
...
Type exit To Stop
`);
permen.question('[\x1b[1m\x1b[31mBARZAN Wifi Killer\x1b[0m]: \n', async (yakin) => {
if (yakin === 'exit') {
...
🇧 🇾  
🇧 🇦 🇷 🇿 🇦 🇳 
                      Selamat web anda sedang di ddos oleh barzan🥵
========================================================================
Target   : ${target}
Duration : ${duration}
Methods  : ${methods}
...
permen.question('[\x1b[1m\x1b[31mBARZAN Chat AI\x1b[0m]: \n', async (yakin) => {
if (yakin === 'exit') {
...
Created And Coded Full By BARZAN

Thx To:
ChatGPT ( Fixing Error )
BARZANNOTSEPUH ( Gatau Ngapain )
...
Allah SWT
`
permen.question('[\x1b[1m\x1b[32mBARZAN TOOLS\x1b[0m]: \n', (input) => {
...
${creatorCredits}`);
    ...
    console.log(`BARZAN Ai Ragbot Started
